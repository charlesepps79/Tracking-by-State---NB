...
data _null_;
call symput('CPP',0.6703); *Must modify CPP per Barbara's plan number.;
call symput('importfile',"WORK.'NB_3.1_18'n");
run;
...
if amount<3000 then Category="1. Small";
else category="2. Large";
...
table STATE*(amtid*FICO_25pt all) all, Mailed="Mail Qty"*f=comma10. booked*f=5.0
